...
class Soal24Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_soal24)
        ...
        val jawabanBenar = "B" // Jawaban benar adalah "Matahari"
        ...
        arrowNext.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, Soal25Activity::class.java)
