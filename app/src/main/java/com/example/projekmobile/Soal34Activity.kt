...
class Soal34Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_soal34) // Pastikan XML-nya sesuai
        ...
        arrowNext.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, Soal35Activity::class.java)
