...
class Soal22Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_soal22)

        val btnA = findViewById<Button>(R.id.btn_a22)
        val btnB = findViewById<Button>(R.id.btn_b22)
        val btnC = findViewById<Button>(R.id.btn_c22)
        val btnD = findViewById<Button>(R.id.btn_d22)
        ...
        arrowNext.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, Soal23Activity::class.java)
