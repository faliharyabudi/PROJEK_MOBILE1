...
class Soal32Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_soal32)
        ...
        val jawabanBenar = "C" // Benang sari
        ...
        arrowNext.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, Soal33Activity::class.java)
