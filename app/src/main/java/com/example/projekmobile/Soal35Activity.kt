...
class Soal35Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_soal35)
        ...
        val jawabanBenar = "A" // Jawaban benar: 21 April
        ...
        arrowNext.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                // Tampilkan toast skor akhir (tidak lanjut ke soal36)
