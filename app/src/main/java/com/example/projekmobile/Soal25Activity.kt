...
class Soal25Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_soal25)
        ...
        val jawabanBenar = "D" // Jawaban: Sang Saka Merah Putih
        ...
        arrowNext.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                // Tidak pindah activity — hanya tampilkan skor akhir (opsional)
        ...
        btnBack.setOnClickListener {
            ...
            btnYakin.setOnClickListener {
                val intent = Intent(this, Soal24Activity::class.java)
